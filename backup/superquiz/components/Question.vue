  ...
  <div>
      <div class="card">
          ...
          <div class="card-body row">
              <div class="col-md-6 text-center"><button @click="onAnswer(btnData[0].correct)" class="btn btn-primary m-3">{{ btnData[0].answer }}</button></div>
              <div class="col-md-6 text-center"><button @click="onAnswer(btnData[1].correct)" class="btn btn-primary m-3">{{ btnData[1].answer }}</button></div>
              <div class="col-md-6 text-center"><button @click="onAnswer(btnData[2].correct)" class="btn btn-primary m-3">{{ btnData[2].answer }}</button></div>
              <div class="col-md-6 text-center"><button @click="onAnswer(btnData[3].correct)" class="btn btn-primary m-3">{{ btnData[3].answer }}</button></div>
          </div>
      </div>
  </div>
</template>
